...
Добро пожаловать в Elevator Service Management Application! Этот проект представляет собой настольное приложение на базе WPF, разработанное для упрощения управления операциями по обслуживанию лифтов. Оно включает модули для управления сотрудниками, клиентами, заявками на обслуживание, журналами и складом запчастей.
...
- Вести журнал сервисных мероприятий с описанием и использованными запчастями.
...
- **Журнал обслуживания:** Ведение журнала сервисных мероприятий с ID заявки, ID сотрудника, датой обслуживания, описанием и использованными запчастями, с фильтрацией по дате.
...
- **Страница журналов обслуживания:** Просмотр и фильтрация журналов обслуживания, экспорт в Excel.
...
Ваши вклады приветствуются! Если вы хотите улучшить этот проект:
1. Сделайте форк репозитория.
2. Создайте новую ветку для вашей функции или исправления ошибки.
3. Зафиксируйте свои изменения с описательными сообщениями.
4. Отправьте изменения в свой форк и отправьте пулл-реквест.
